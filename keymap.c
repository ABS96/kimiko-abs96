...
[_LNUM] = LAYOUT(
    ...
    KC_F12,  HU_1,    HU_2,    HU_3,    HU_4,    KC_F5,                     _______, OM_RSFT, OM_RCTL, OM_LALT, OM_RGUI, _______,
...
[_RNUM] = LAYOUT(
    ...
    _______, OM_LGUI, OM_LALT, OM_LCTL, OM_LSFT, _______,                   KC_F6,   HU_7,    HU_8,    HU_9,    HU_0,    KC_F11,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, HU_6,    _______, _______, _______, _______,
                      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
[_LMOD] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
